        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            ...
            <button
              ...
              className="bg-primary hover:bg-indigo-600 text-white px-4 py-2 rounded-lg transition-colors"
            >
          ...
          {showAddForm && (
            <div className="bg-surface rounded-xl p-6 mb-8 shadow-lg">
              <h2 className="text-xl font-semibold text-text-primary mb-4">Add New Task</h2>
              <form onSubmit={handleCreateTask}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    <label htmlFor="title" className="block text-text-secondary mb-1">Title *</label>
                    <input
                      type="text"
                      id="title"
                      value={newTask.title}
                  ...
                  <div>
                    <label htmlFor="priority" className="block text-text-secondary mb-1">Priority</label>
                    <select
                      id="priority"
                ...
                <div className="mb-4">
                  <label htmlFor="description" className="block text-text-secondary mb-1">Description</label>
                  <textarea
                    id="description"
                ...
                <div className="mb-4">
                  ...
                  <div className="flex">
                    <input
                      ...
                      className="flex-1 px-3 py-2 border border-border rounded-l-lg focus:outline-none focus:ring-2 focus:ring-primary"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    <label htmlFor="due_date" className="block text-text-secondary mb-1">Due Date</label>
                    <input
                      type="datetime-local"
                      id="due_date"
                  ...
                  <div>
                    <label className="block text-text-secondary mb-1">Recurring</label>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredTasks.map((task) => (
                <div
                  key={task.id}
                  className={`bg-surface rounded-xl p-6 shadow-lg border-l-4 ${
                    task.priority === 'high' ? 'border-danger' :
                    task.priority === 'medium' ? 'border-warning' : 'border-secondary'
                  }`}
                >
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    ...
                    {task.tags.map((tag, idx) => (
                      <span key={idx} className="px-2 py-1 bg-gray-100 text-text-secondary rounded-full text-xs">
                        {tag}
                      </span>
                    ))}
                  </div>
